...
void init_memory_layout_variables()
{
    ...
    useful_align_up(&kernel_end_va_page_aligned, PAGE_SIZE);
    ...
    useful_align_up(&kernel_text_end_va_page_aligned, PAGE_SIZE);
    ...
    useful_align_up(&kernel_rodata_end_va_page_aligned, PAGE_SIZE);
    ...
    useful_align_up(&kernel_data_end_va_page_aligned, PAGE_SIZE);
    ...
    useful_align_up(&kernel_bss_end_va_page_aligned, PAGE_SIZE);
}
