...
void init_memorylayout_variables()
{
    ...
    useful_align_to(&kernel_end_physical_addr_page_aligned, PMM_PAGE_SIZE);
    kernel_end_virtual_addr_page_aligned = kernel_end_virtual_addr;
    useful_align_to(&kernel_end_virtual_addr_page_aligned, PMM_PAGE_SIZE);
    ...
    useful_align_to(&kernel_text_end_physical_addr_page_aligned, PMM_PAGE_SIZE);
    kernel_text_end_virtual_addr_page_aligned = kernel_text_end_virtual_addr;
    useful_align_to(&kernel_text_end_virtual_addr_page_aligned, PMM_PAGE_SIZE);
    ...
    useful_align_to(&kernel_rodata_end_physical_addr_page_aligned, PMM_PAGE_SIZE);
    kernel_rodata_end_virtual_addr_page_aligned = kernel_rodata_end_virtual_addr;
    useful_align_to(&kernel_rodata_end_virtual_addr_page_aligned, PMM_PAGE_SIZE);
    ...
    useful_align_to(&kernel_data_end_physical_addr_page_aligned, PMM_PAGE_SIZE);
    kernel_data_end_virtual_addr_page_aligned = kernel_data_end_virtual_addr;
    useful_align_to(&kernel_data_end_virtual_addr_page_aligned, PMM_PAGE_SIZE);
    ...
    useful_align_to(&kernel_bss_end_physical_addr_page_aligned, PMM_PAGE_SIZE);
    kernel_bss_end_virtual_addr_page_aligned = kernel_bss_end_virtual_addr;
    useful_align_to(&kernel_bss_end_virtual_addr_page_aligned, PMM_PAGE_SIZE);
}
